 ...
 * Size: 20 px
 * Bpp: 4
 * Opts: --bpp 4 --size 20 --no-compress --stride 1 --align 1 --font Montserrat-Medium.ttf --symbols 1234567890ß´qwertzuiopü+asdfghjklöä#<yxcvbnm,.-!"§$%&/()=?`QWERTZUIOPÜ*ASDFGHJKLÖÄ'>YXCVBNM;:__  --range 32-127 --format lvgl -o lv_font_montserrat_20.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 6676, .adv_w = 160, .box_w = 10, .box_h = 17, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 6761, .adv_w = 192, .box_w = 6, .box_h = 3, .ofs_x = 4, .ofs_y = 12},
    {.bitmap_index = 6770, .adv_w = 234, .box_w = 16, .box_h = 18, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 6914, .adv_w = 269, .box_w = 16, .box_h = 19, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7066, .adv_w = 253, .box_w = 13, .box_h = 19, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7190, .adv_w = 216, .box_w = 12, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7280, .adv_w = 191, .box_w = 10, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7355, .adv_w = 203, .box_w = 12, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7445, .adv_w = 217, .box_w = 11, .box_h = 15, .ofs_x = 1, .ofs_y = 0}
};
